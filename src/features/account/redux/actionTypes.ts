...
export enum AccountActions {
  ...
  CANCEL_MONEY_TRANSFER_START = "CANCEL_MONEY_TRANSFER_START",
  CANCEL_MONEY_TRANSFER_SUCCESS = "CANCEL_MONEY_TRANSFER_SUCCESS",
  CANCEL_MONEY_TRANSFER_FAIL = "CANCEL_MONEY_TRANSFER_FAIL",
...
export interface CancelMoneyTransferStartAction {
  type: AccountActions.CANCEL_MONEY_TRANSFER_START;
}
export interface CancelMoneyTransferSuccessAction {
  type: AccountActions.CANCEL_MONEY_TRANSFER_SUCCESS;
}
export interface CancelMoneyTransferFailAction {
