...
import UserAvatar from "_assets/img/imageUser.svg";
        ...
        main={
          <React.Fragment>
            <Box component="header" className={styles.header}>
              <Account name={String(user?.name ?? "")} image={UserAvatar} />
            </Box>
            <ActionList className={styles.list}>
              <ActionListItem key="Nome social" onClick={onChangeNicknameClick}>
                <Typography>Nome social:</Typography>
                <Typography>
                  <strong>{user?.name}</strong>
                </Typography>
              </ActionListItem>
              <ActionListItem key="Email">
                <Typography>Email:</Typography>
                <Typography>
                  <strong>{user?.mail}</strong>
                </Typography>
              </ActionListItem>
              <ActionListItem key="Telefone">
                <Typography>Telefone:</Typography>
                <Typography>
                  <strong>{phoneNumber}</strong>
                </Typography>
              </ActionListItem>
              <ActionListItem key="Endereço" onClick={onAddressClick}>
                <Typography>Endereço</Typography>
              </ActionListItem>
              <ActionListItem key="Sair" onClick={onExitButtonClick}>
                Sair
              </ActionListItem>
            </ActionList>
          </React.Fragment>
